			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="contact-info">
						...
						<address>
							<p>TS-HOMEWARE</p>
							<p>28 Cổ Nhuế, Phường Bắc Từ Liêm </p>
							<p>TP.Hà Nội, Việt Nam</p>
							<p>Mobile: +0976 417 587</p>
							<p>Email: duongphongg15@gmail.com</p>
						</address>
						<div class="social-networks">
							<h2 class="title text-center">MẠNG XÃ HỘI</h2>
							<ul>
								<li><a target="_blank" href="https://www.facebook.com/dphong15"><i class="fa fa-facebook"></i></a></li>
